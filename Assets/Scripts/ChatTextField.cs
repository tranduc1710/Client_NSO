...
public class ChatTextField : IActionListener
{
	...
	//		if (!Main.isPC)
	//		{
 //               //Debug.LogError("Ok chat " + mScreen.keyTouch);
 ...
 //               //TouchScreenKeyboard.Open(ipKeyboard.TEXT, TouchScreenKeyboardType.Default);
               

 //                TouchScreenKeyboard.Open(
 //                   text: string.Empty,
 //                   t: TouchScreenKeyboardType.Default,
 //                   b1: false, // Ví dụ: không tự động viết hoa
 //                   b2: false, // Ví dụ: không sử dụng chế độ mật khẩu
 //                   type: false, // Ví dụ: không cần kiểu bàn phím đặc biệt
 //                   b3: false, // Ví dụ: không sử dụng tham số tùy chọn khác
 //                   caption: "Chat" // Tiêu đề của bàn phím
 //               );
 //           }
	//	}
	//	tfChat.setText(string.Empty);
