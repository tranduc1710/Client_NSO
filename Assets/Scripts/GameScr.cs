...
public class GameScr : mScreen, IChatable, IActionListener
{
	...
	private sbyte[] arrowCaptcha;

	public sbyte indexThanThu;

	public MyVector clan_thanthu;
	...
	public GameScr()
	{
		...
		xM = new int[2];
		yM = new int[2];
		YenCards = new string[9] { "10000", "20000", "30000", "50000", "100000", "200000", "500000", "1000000", "5000000" };
		wColoerMp = 85;
		hColorMp = 11;
		...
		clan_thanthu = new MyVector();
		strTime = string.Empty;
		arrNgocKhamEXP = new int[11][]
		{
			new int[2],
			new int[2] { 200, 10 },
			new int[2] { 500, 20 },
	...
	{
		objKhu = new object();
		//night = Image.createImage(File.ReadAllBytes("NinjaMax/night.png"));
	...
	protected void actMenu()
	{
		...
		Command o2 = new Command("MenuAuto", 110021);
		new Command(mResources.MENUGAMESCR[2], 110002);
		Command o3 = new Command(mResources.MENUGAMESCR[3], 110003);
		Command o4 = new Command(mResources.MENUGAMESCR[4], 110004);
		new Command(mResources.MENUGAMESCR[0], 110005);
		Command o5 = new Command(mResources.MENUGAMESCR[6], 110006);
		...
		Command o6 = new Command("Thủ khố", 110022);
		Command o7 = new Command("Tự sát", 110023);
		Command o8 = new Command("Khu vực", 110024);
	...
	private void paintDebugInfo(mGraphics g)
	{
		...
		try
		{
			...
			if (Char.getMyChar().isHuman || Char.getMyChar().isNhanban)
			{
				...
				{
					mFont.tahoma_7_red.drawString(g, "Ninja Hoa quả", 220, 20, 0, mFont.tahoma_7_grey);
				}
				else
				{
			...
			if (TileMap.typeMap != TileMap.MAP_CHIENTRUONG)
			{
				...
				if (Char.getMyChar().isHumanz())
				{
					if (Char.getMyChar().taskMaint != null)
					{
						...
						{
							num8++;
							text = Char.getMyChar().taskMaint.subNames[Char.getMyChar().taskMaint.index - num8];
						}
			...
			{
				num = 4;
				string text3 = Char.getMyChar().mobFocus.getTemplate().name + " lv" + Char.getMyChar().mobFocus.level.ToString() + " - id: " + Char.getMyChar().mobFocus.templateId;
	...
	private void actBagSelectItem()
	{
		...
		myVector.addElement(new Command("Bán", 11072));
