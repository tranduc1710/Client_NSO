...
public class Item
{
	...
	{
		if (template.type != 0 && template.type != 2 && template.type != 4 && template.type != 6)
		{
			return template.type == 8;
		}
		return true;
	}
	...
	{
		if (template.type != 3 && template.type != 5 && template.type != 7)
		{
			return template.type == 9;
		}
		return true;
	}
	...
	{
		if (itemId != 194 && itemId != 94 && itemId != 95 && itemId != 96 && itemId != 97)
		{
			return itemId == 98;
		}
		return true;
	...
	{
		if (itemId != 109 && itemId != 110 && itemId != 111 && itemId != 112)
		{
			return itemId == 113;
		}
		return true;
	...
	{
		if (itemId != 114 && itemId != 115 && itemId != 116 && itemId != 117)
		{
			return itemId == 118;
		}
		return true;
	...
	{
		if (itemId != 119 && itemId != 120 && itemId != 121 && itemId != 122)
		{
			return itemId == 123;
		}
		return true;
	...
	public int MaxPercentUpdate()
	{
		return GameScr.maxPercents[upgrade];
	}

	public int getPecentUpgradeDoRight(int updrade)
	{
		int num = GameScr.crystals[template.id] * 100 / GameScr.upAdorn[updrade];
